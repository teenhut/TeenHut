...
export default function Sidebar() {
  ...
  return (
    <aside className="w-64 bg-white text-black flex flex-col h-screen sticky top-0 border-r border-gray-200">
      <div className="p-6 flex items-center gap-3">
        ...
        <span className="text-xl text-[#269398] font-debata">Teen Hut</span>
      </div>
      ...
      <div className="p-4 border-t border-gray-200">
        <div className="flex items-center justify-between gap-3 px-2">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-full bg-gray-100 flex items-center justify-center font-bold text-black uppercase">
              {user?.username?.[0] || "U"}
            </div>
