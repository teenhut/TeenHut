...
export default function UploadModal({
  ...
  return (
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
      <div className="bg-white text-black rounded-xl w-full max-w-4xl h-[80vh] flex flex-col shadow-2xl overflow-hidden relative border border-gray-200">
        {/* Header */}
          ...
          {step === 1 ? (
            ...
            >
              ...
              <Button
                ...
                className="bg-black hover:bg-gray-800 text-white font-bold px-6 py-2 rounded-sm uppercase text-sm"
              >
                Select Files
              </Button>
              <input
            ...
            <div className="flex flex-col lg:flex-row h-full">
              ...
              <div className="flex-1 p-8 space-y-6 overflow-y-auto">
                ...
                <div className="space-y-2">
                  <div className="border border-gray-300 rounded-md px-3 py-2 bg-white focus-within:border-black transition-colors">
                ...
                <div className="space-y-2">
                  <div className="border border-gray-300 rounded-md px-3 py-2 bg-white focus-within:border-black transition-colors h-40">
                    <label className="text-xs text-gray-500 block mb-1">
                      Description
                    </label>
                    <textarea
                      ...
                      className="w-full h-full bg-transparent border-none outline-none text-black placeholder-gray-400 resize-none"
          ...
          <div className="p-4 border-t border-gray-200 flex items-center justify-between bg-gray-50">
            ...
            <div className="flex items-center gap-2">
              ...
              <Button
                ...
                className="bg-black hover:bg-gray-800 text-white font-bold px-6 rounded-sm uppercase text-sm disabled:opacity-50 disabled:cursor-not-allowed"
              >
